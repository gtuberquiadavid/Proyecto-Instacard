Proyecto de limpieza de datos y preparación de informe en donde brindaba
información sobre los hábitos de compra de los clientes de Instacart (plataforma
de entregas de comestibles donde la clientela puede registrar un pedido y hacer
que se lo entreguen, similar a Uber Eats). Proporcionando análisis mediante gráficos
comunican los resultados. (Python – Pandas). Programa educativo.
